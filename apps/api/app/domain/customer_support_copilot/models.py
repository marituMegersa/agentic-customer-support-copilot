...
class AgenticCustomerSupportCopilotSession(Base):
    __tablename__ = "customer_support_copilot_sessions"
...
class AgenticCustomerSupportCopilotItem(Base):
    __tablename__ = "customer_support_copilot_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("customer_support_copilot_sessions.id"))
